...
> 
> 我们力求减少不必要的配置，贯彻约定大于配置的精神，让该插件易用、好用。让大家不再为过多的配置而感到头痛！
> 
> 我们追求极致的 **体验**。让你可以根据自己的需要定制生成模版，支持模版实时预览，同时支持多表生成配置SQL方法动态生成对应表的SQL XML文件。
> 
> 本文只介绍插件绝大多数功能,按"入口 → 操作步骤 → 注意事项"组织,配合截图,零基础也能上手。
> 
> 我们的目标是:让 MyBatis 开发更简单、更高效、更智能。
